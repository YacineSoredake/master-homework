...
public class XTEAa {
    ...
    public static void main(String[] args) throws IOException {
        ...
        xtea.encryptFile(inputFile, encryptedFile, mode, iv);
        xtea.decryptFile(encryptedFile, decryptedFile, mode, iv);

        System.out.println("Chiffrement/déchiffrement terminé en mode " + mode);
    }
}
